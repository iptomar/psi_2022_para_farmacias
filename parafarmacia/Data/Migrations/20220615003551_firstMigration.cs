    ...
    public partial class firstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", "262c279e-eda4-4732-9e0a-08d00c5240fa", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "2", "a6cbcf1f-4f30-4c5b-a196-e1d7bcf50b7b", "User", "USER" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "99fd8642-3f3a-4808-9435-eb601fd9f7d0", "admin@admin", true, false, null, "Admin", "ADMIN@ADMIN", "ADMIN@ADMIN", "AQAAAAEAACcQAAAAEATE/6P3o1uMEoapD7I7pdDWVOhmJM2oXNMPgps4Pr6MbudBA33gyMrjC7/hVEGZiA==", null, false, "", new DateTime(2022, 6, 15, 1, 35, 50, 642, DateTimeKind.Local).AddTicks(6950), false, 1, "admin@admin" });
