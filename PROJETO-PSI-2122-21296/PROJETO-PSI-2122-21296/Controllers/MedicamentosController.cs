...
using PROJETO_PSI_2122_21296.Data;
using PROJETO_PSI_2122_21296.Models;

namespace PROJETO_PSI_2122_21296.Controllers
{
    ...
    public class MedicamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Preco,DataValidade")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Preco,DataValidade")] Medicamento medicamento)
        {
